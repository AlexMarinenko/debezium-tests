...
INSERT INTO products(name,description,weight,created_at)
VALUES ('scooter','Small 2-wheel scooter',3.14, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('car battery','12V car battery',8.1, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('12-pack drill bits','12-pack of drill bits with sizes ranging from #40 to #3',0.8, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('hammer','12oz carpenter''s hammer',0.75, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('hammer','14oz carpenter''s hammer',0.875, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('hammer','16oz carpenter''s hammer',1.0, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('rocks','box of assorted rocks',5.3, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('jacket','water resistent black wind breaker',0.1, SYSDATETIME());
INSERT INTO products(name,description,weight,created_at)
VALUES ('spare tire','24 inch spare tire',22.2, SYSDATETIME());
